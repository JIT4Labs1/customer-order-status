...
<style>
  * { margin:0; padding:0; box-sizing:border-box; }
  ...
  /* ── Mobile (tablet & phone). All rules scoped to ≤760px so the desktop view
     is byte-for-byte unchanged. Data-dense tables scroll horizontally. ── */
  @media (max-width:760px){
    .layout{ flex-direction:column; padding:12px 10px 30px; }
    ...
    .kpi{ min-width:0; flex:1 1 40%; padding:10px 8px; }
    .kpi .v{ font-size:22px; }
    /* Mode tabs become one swipeable row instead of wrapping to 3 cramped rows */
    .modebar{ flex-wrap:nowrap; overflow-x:auto; -webkit-overflow-scrolling:touch; padding:12px 12px 0; gap:6px; }
    .mode-btn{ flex:0 0 auto; white-space:nowrap; padding:9px 13px; font-size:12px; }
    ...
    .pnl-wrap{ padding:14px 12px; }
    .ca-visuals{ gap:18px; padding:0 12px; }
