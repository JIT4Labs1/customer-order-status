...
function payFulfillCell(v){
  ...
  if(f==='Partially'){
    if(v.so_num) return '<a href="#" onclick="showFulfill(\''+v.so_num+'\');return false;" style="color:#b54708;font-weight:600;text-decoration:none;">Partially <span style="font-size:11px;">▦</span></a>';
