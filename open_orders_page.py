...
function cjStepHtml(step){
  ...
  return '<div style="padding:2px 0 2px 20px;color:#5a6b7b;font-size:12px;"><span style="color:#aab4bf;">▸</span> <span title="'+escapeHtml(step.label||'')+'">'+escapeHtml(cjShortUrl(step.label))+'</span></div>';
}
